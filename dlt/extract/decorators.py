...
def resource(
    ...
    Args:
        ...
        columns (Sequence[TAnySchemaColumns], optional): A list, dict of column schemas.
...
def transformer(
    ...
    Args:
        ...
        columns (Sequence[TAnySchemaColumns], optional): A list, dict of column schemas. Typed dictionary describing column names, data types, write disposition and performance hints that gives you full control over the created table schema.
            This argument also accepts a callable that is used to dynamically create tables for stream-like resources yielding many datatypes.
